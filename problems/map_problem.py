...
class MapProblem(GraphProblem):
    ...
    def expand_state_with_costs(self, state_to_expand: GraphProblemState) -> Iterator[OperatorResult]:
        ...
        for i, link in enumerate(junction.outgoing_links):
            if link is None:
                print("WTF1")
            yield OperatorResult(MapState(link.target), link.distance)
    ...
    def is_goal(self, state: GraphProblemState) -> bool:
        ...
        # print("A ", state.junction_id == self.target_junction_id)
